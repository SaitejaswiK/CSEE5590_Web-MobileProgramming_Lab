...
@Component({
  selector: 'app-webmobile-page',
  templateUrl: './webmobile-page.component.html',
  styleUrls: ['./webmobile-page.component.css']
})
export class WebmobilePageComponent implements OnInit {
  courseName = 'web/mobile Course';
  courseCategory = 'web/mobile';
  credits = '3';
  ratings = '4.6'
  ...
  enroll_web = function() {
    ...
    this.http1.get(this.url).subscribe((res: any) => {
      ...
      this.courseName = 'Web/Mobile Course';
      this.courseCategory = 'web/mobile';
      this.credits = '3';
      this.ratings = '4.6';
