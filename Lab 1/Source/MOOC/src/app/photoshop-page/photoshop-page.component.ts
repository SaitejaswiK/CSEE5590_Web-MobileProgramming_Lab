...
@Component({
  selector: 'app-photoshop-page',
  templateUrl: './photoshop-page.component.html',
  styleUrls: ['./photoshop-page.component.css']
})
export class PhotoshopPageComponent implements OnInit {
  ...
  enroll_photoshop = function() {
    ...
    this.http1.get(this.url).subscribe((res: any) => {
      ...
      this.courseName = 'Photoshop Course';
      this.courseCategory = 'Photoshop';
      this.credits = '3';
      this.ratings = '4.6';
